/**
 * @file Parâmetros de Cálculo para o ano de 2021.
 * @module data/parametros-2021
 * @description Este arquivo contém os parâmetros legais e fiscais específicos para o ano de 2021,
...
export default {
  ...
  inssCeiling: 751.99,
  inssTable: [
    { limit: 1100.00, rate: 0.075 },
    { limit: 2203.48, rate: 0.09 },
    { limit: 3305.22, rate: 0.12 },
    { limit: 6433.57, rate: 0.14 }
  ],
  irrfTable: [
